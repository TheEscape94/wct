...
class the100_promo extends WP_Widget {
    ...
    public function __construct() {
    	parent::__construct(
    		'the100_promo', __('The100: Call to Action','the100'), array(
    			'description' => __('A widget that Gives field to add image and skills', 'the100')
    			)
    		);
    }
    ...
    public function widget($args, $instance) {
        ...
        echo $before_widget;
        ?>
        <div class="promo-widget-wrap <?php echo esc_attr($promo_layout); if(!empty($promo)){echo " has-image";}?> clearfix" <?php if($promo_layout=="lay-three" && $promo!=''){echo "style='background-image:url(".$promo.")'";}?>>
            <div class='widget-content-wrapper'>
                ...
                <div class="caption">
									<h2 class="skills-title"> Our skills </h2>
										<?php echo do_shortcode("[wsc id='761']"); ?>    <!-- SKILL BAR NA FRONT-PAGE -->
                </div>
            </div>
        </div>
	        <?php
