...
function the100_scripts() {
	...
	wp_enqueue_style( 'the100-google-fonts', add_query_arg( $query_args, "//fonts.googleapis.com/css" ) );
	wp_enqueue_style( 'the100-font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css' );
	wp_enqueue_style('the100-animate', get_template_directory_uri() . '/css/animate.css' );
	wp_enqueue_style('the100-owl', get_template_directory_uri() . '/css/owl.carousel.css' );
	wp_enqueue_style('the100-owl-theme', get_template_directory_uri() . '/css/owl.theme.default.css' );
	...
	wp_enqueue_script( 'the100-directional-hover', get_template_directory_uri() . '/js/jquery.directional-hover.min.js', array(), '20151215', true );
	...
	wp_enqueue_script( 'the100-owl', get_template_directory_uri() . '/js/owl.carousel.js', array('jquery'), '1.3.3', true );
	wp_enqueue_script( 'the100-wow', get_template_directory_uri() . '/js/wow.js', array('jquery'), '1.1.3', true );
