	...
	<div class="main-footer">
		<div class="ed-container">
			<div class="site-info wow zoomIn">
				...
				<?php esc_html_e('');  ?><a  title="<?php echo esc_html_e('Free WordPress Theme','the100');?>" href="<?php echo esc_url( __( 'http://localhost/wct1/', 'Web Connection Team' ) ); ?>"><?php esc_html_e( 'Web Connection Team', 'Web Connection Team' ); ?> </a>
				<span><?php echo esc_html_e('');?></span>
			</div><!-- .site-info -->
			<?php
